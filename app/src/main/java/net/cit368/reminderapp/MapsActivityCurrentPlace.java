...
public class MapsActivityCurrentPlace extends AppCompatActivity
    ...
    private void findLocationFromInput(String s) {
        ...
        Toast.makeText(getApplicationContext(),"Address is " + s,Toast.LENGTH_SHORT).show();
        ...
        if(addresses.size() > 0){
            ...
            mMap.moveCamera(CameraUpdateFactory
                    .newLatLngZoom(mSearchLocation, DEFAULT_ZOOM));
            //searchLoc.setText("");
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        simpleSearchView = (SearchView) findViewById(R.id.app_bar_search); // inititate a search view
        return true;
    }
    ...
    public void onMapReady(GoogleMap map) {
        ...
        new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                //CharSequence inputText = simpleSearchView.setQuery;
                return true;
            }

            @Override
            public boolean onQueryTextSubmit(String query) {
                CharSequence inputText = simpleSearchView.getQuery(); // get the query string currently in the text field
                Toast.makeText(getApplicationContext(),inputText,Toast.LENGTH_SHORT).show();
                findLocationFromInput(inputText.toString());
                return true;
            }
        };
